...
//   e.preventDefault();
//   try {
//     console.log("Submitting address payload:", { ...address, userId: user._id });

//     const { data } = await axios.post("/api/address/add", {
//       ...address,
//       //zipcode: Number(address.zipcode), // ensure number type
//       userId: user._id,
//     });
...
// };
  ...
  return (
    <div className='mt-16 pb-16'>
        ...
        className='font-semibold text-green-500'>Address</span></p>
        <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
            <div className='flex-1 max-w-md'>
                <form onSubmit={onsubmitHandler} className='space-y-3 mt-6 text-sm'>
                    ...
                    <button className='w-full mt-6 bg-green-500 text-white py-3
                    hover:bg-green-dull transition cursor-pointer uppercase'>
                        Save address
                    </button>
