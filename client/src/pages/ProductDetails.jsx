    ...
    return product && (
        <div className="mt-12">
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 md:gridd-cols-4 gap-3
                ...
                <button onClick={()=>{navigate("/products"); scrollTo(0,0)}} className="max-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-green-100 transition">See more</button>
            </div>
        </div>
    );
};
